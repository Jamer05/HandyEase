...
<body>
    <div class="header">
        ...
        <div class="main">
            <div class="container">
                <div class="register">
                    <form action="addauth.php" method="post" enctype="multipart/form-data">
                        <div class="register-top-grid">
                            ...
                            <div class="wow fadeInRight" data-wow-delay="0.4s">
                                ...
                                <input type="text" name="emailAuth" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                            </div>
                            <div class="wow fadeInRight" data-wow-delay="0.4s">
                                <span>Location
                                    <label>*
                            ...
                            <div class="wow fadeInRight" data-wow-delay="0.4s">
                                <span>City/Municipality
                                    <label>*</label>
                                    <select name="city">
                                        <option value="Sumacab" selected>Sumacab</option>
                            ...
                            <div class="wow fadeInRight" data-wow-delay="0.4s">
                                ...
                                <select name='selser'>
                                    <option value="Plumber" selected>Plumber
                                    </option>
                                    ...
                                    <option value="AC and Refrigerator">AC & Refrigerator
                                    </option>
                                </select>
                            </div>
                            <div class="wow fadeInRight" data-wow-delay="0.4s">
