...
<body class="application">
    ...
    <div id="feedbackModal" class="modal">
        <div class="modal-content">
            ...
            <input type="text" id="feedbackInput" placeholder="Enter here">
                ...
                <table class="table-responsive" id="customers2" align="right">
                    ...
                    <tbody id="table-body">
                        ...
                        if (mysqli_num_rows($result) == 1) {
                            ...
                            WHERE (service.transflag= 1 OR service.status = 'Approved')
                            ...
                            if (mysqli_num_rows($res) > 0) {
                                while ($row = mysqli_fetch_array($res)) {
                                    if ($row['transflag'] == 1) {
                                        ...
                                        echo "<td name='Worker'>" . ($row[21] != '' ? $row[21] : 'Ongoing') . "</td>";
                                        if ($row[13] == "") {
                                            echo "<td><input type='button' value='Add' id='button' onclick='openModal()' style='background-color:green;color:white;border-radius:25px;'></td>";
                                        } else {
                                            echo "<td name='Feedback'>Done</td>";
                                        }
    ...
    <script>
        ...
        function submitFeedback() {
            ...
            if (feedback.trim() === "") {
                ...
                window.location.href = 'feedback.php?feedback=' + encodedFeedback;
            }
            closeModal();
        }
