...
<body>
                ...
                <div class="register">
                    <form action="addtrans.php" method="post">
                        <div class="register-top-grid">
                            ...
                            <div class="wow fadeInRight" data-wow-delay="0.4s">
                                <span>Authorizer Name<label>*</label></span>
                                <input type="text" name="authorizer" id="authorizer" readonly>
                            </div>
                            <div class="wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            <div class="wow fadeInLeft" data-wow-delay="0.4s">
                                ...
                                <select name="wage">
                                    <option value="200" selected>Plumber</option>
                                    <option value="200">Electrician </option>
                                    <option value="160">Carpenter</option>
                                    <option value="160">Washing Machine</option>
                                    <option value="130">AC & Refrigerator</option>
                                </select>
                            </div>
                            <div class="wow fadeInLeft" data-wow-delay="0.4s">
 ...
 ">
    ...
    <script type="text/javascript">
        ...
        document.getElementById('authorizer').value = "<?php echo $authorizer; ?>";
