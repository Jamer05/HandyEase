                        ...
                        if (mysqli_num_rows($res) > 0) {
                            while ($row = mysqli_fetch_array($res)) {
                                if ($row[12] == '0') {
                                    ...
                                    echo "<td><input type='button' value='  No  ' onclick='confirmDecline()' style='background-color:red;color:white;border-radius:25px;'></td>";
    ...
    <script type="text/javascript">
        ...
        function submitDeclineReason() {
            ...
            if (reason.trim() === "") {
                ...
                window.location.href = 'decline.php?reason=' + encodedReason;
            }
        }
